...
namespace GreenOnions.Utility
{
    public static class BotInfo
    {
        ...
        public static Dictionary<string, bool> PluginStatus
        {
            get
            {
                string strValue = JsonHelper.GetSerializationValue(JsonHelper.JsonConfigFileName, JsonHelper.JsonNodeNamePlugin, nameof(PluginStatus));
                if (string.IsNullOrEmpty(strValue))
                    return new Dictionary<string, bool>();
                return JsonConvert.DeserializeObject<Dictionary<string, bool>>(strValue);
            }
            set => JsonHelper.SetSerializationValue(JsonHelper.JsonConfigFileName, JsonHelper.JsonNodeNamePlugin, nameof(PluginStatus),  JsonConvert.SerializeObject(value));
        }

namespace GreenOnions.BotManagerWindows.Controls
{
    partial class CtrlRepeater
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Controls.Add(this.chkRewindGif);
            this.Controls.Add(this.lblRewindGifProbability);
            this.Controls.Add(this.lblVerticalMirrorImageProbability);
            this.Controls.Add(this.lblHorizontalMirrorImageProbability);
            this.Controls.Add(this.lblSuccessiveRepeatCount);
            this.Controls.Add(this.txbRewindGifProbability);
            this.Controls.Add(this.lblRandomRepeatProbability);
            this.Controls.Add(this.txbVerticalMirrorImageProbability);
            this.Controls.Add(this.txbHorizontalMirrorImageProbability);
            this.Controls.Add(this.txbSuccessiveRepeatCount);
            this.Controls.Add(this.txbRandomRepeatProbability);
            this.Controls.Add(this.chkVerticalMirrorImage);
        ...
        private CheckBox chkReplaceMeToYou;
        private CheckBox chkRewindGif;
        private Label lblRewindGifProbability;
        private Label lblVerticalMirrorImageProbability;
        private Label lblHorizontalMirrorImageProbability;
        private Label lblSuccessiveRepeatCount;
        private TextBox txbRewindGifProbability;
        private Label lblRandomRepeatProbability;
        private TextBox txbVerticalMirrorImageProbability;
        private TextBox txbHorizontalMirrorImageProbability;
        private TextBox txbSuccessiveRepeatCount;
        private TextBox txbRandomRepeatProbability;
        private CheckBox chkVerticalMirrorImage;
        private CheckBox chkHorizontalMirrorImage;
        private CheckBox chkSuccessiveRepeat;
        private CheckBox chkRandomRepeat;
    }
}
